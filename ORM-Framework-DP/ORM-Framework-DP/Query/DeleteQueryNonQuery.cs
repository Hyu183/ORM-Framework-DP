...
namespace ORM_Framework_DP
{
    ...
    {
        private T obj;
        public DeleteQueryNonQuery(T obj, DBConnection dBConnection, QueryBuilder queryBuilder, AttributeHelper<T> attributeHelper) : base(dBConnection, queryBuilder, attributeHelper)
        {
            this.obj = obj;
        }
